...
Bulma Clean Theme uses the Bulma frontend framework. Check out the [Bulma docs](https://bulma.io/documentation/){:target="_blank"} for more information.
...
You can overwrite any of the [Bulma initial variables](http://versions.bulma.io/0.7.0/documentation/overview/variables/){:target="_blank"} in this way as long as they are declared before the `@import "main";`.
...
Please see the Jekyll documentation for [Overriding theme defaults](https://jekyllrb.com/docs/themes/#overriding-theme-defaults){:target="_blank"} for more information.